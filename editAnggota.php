...
<html lang="en">
    ...
    <section>
        <div class="container mt-4">
            ...
            <form action="logicEditAnggota.php" method="post">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="text" name="no_hp" class="form-control" id="exampleFormControlInput1" value="<?= $data['no_hp'] ?>">
                </div>
                <div class="form-group mt-2">
                    <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                    <textarea class="form-control" name="alamat" id="exampleFormControlTextarea1" rows="3" ><?= $data['alamat'] ?></textarea>
                </div>
                <input type="submit" value="Ubah" name="edit" class="btn btn-warning mt-4">
            </form>
            </div>
        </section>
